    ...
    <div className="min-h-screen flex flex-col">
      <main className="flex flex-col items-center px-6 py-8 w-full">
        ...
        <div className="w-full max-w-4xl flex justify-end mt-4">
          <button className="flex items-center gap-1 border border-gray-400 rounded-md px-3 py-1.5 text-sm font-medium text-black bg-white hover:bg-gray-100 transition">
            Filter
